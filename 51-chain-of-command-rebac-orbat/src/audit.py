"""CHAIN-OF-COMMAND — SHA-256 hash-chained audit log.

Every ReBAC verdict is appended to a single chain. Tampering with any row
breaks verification. Pattern lifted from REDLINE / GUARDIAN / GUARDRAIL.
"""
...
AUDIT_LOG = AUDIT_DIR / "cmd_audit.jsonl"
